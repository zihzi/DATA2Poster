...
if try_true or (st.session_state["bt_try"] == "T"):
    ...
    if api_keys_entered:
        ...
        **Output (exact JSON)**
        ...
        user_selected_column = col_select_json["key_columns"][0]["column"]
        ...
        test_conclusion = self_augmented_knowledge(openai_key, chosen_dataset, list(head), user_selected_column, st.session_state["base_fact"], st.session_state["sub_fact"])
        st.subheader("Test Conclusion:")
        st.write(test_conclusion)
